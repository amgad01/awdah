import { getUpdatePracticingPeriodUseCase } from '../../../../shared/di/salah-use-cases';
...
export const handler = createHandler(CONTEXTS.SALAH, getUpdatePracticingPeriodUseCase(), {
